...
## Validation
- [ ] CMake generation succeeds without errors.
- [ ] Compiles cleanly with high warning levels.
- [ ] Application opens a window with the specified title and dimensions.
- [ ] Window background is the expected color (Teal).
- [ ] Console shows "Engine Initialized" and "OpenGL Version: X.X" logs.
- [ ] Window responds to resize and close events.
